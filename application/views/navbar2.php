  <nav class="navbar navbar-default navbar-fixed-top" style="height: 100px; background-color: #f8f8f8; border:1px solid #f8f8f8; " >
        ...
        <ul class="nav navbar-nav navbar-right pull-right">
            ...
            <li>
                <a  href="#"><span class="icon-search" style="font-size: 48px; color: #32b6c7"> </span>
                </a>
            </li>
            <li>
		<a href="<?php echo site_url('Login/index') ?>">
                    <span class="icon-login" style="color:#F9B031; font-size:48px;"></span>
                </a>
            </li>
        
            <li align="center">
                <a href="<?php echo site_url('Regist/registform') ?>">
                    <span class="icon-daftar" style="color:#2F546C; font-size:48px;"></span>
                </a>
            </li>
